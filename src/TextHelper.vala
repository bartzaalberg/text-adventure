...
public class TextHelper : Object {
    ...
    public void show_opening_text () {
        ...
        stdout.printf ("\n");
        stdout.printf ("\n");
        stdout.printf ("A worried-looking man I would come to know as " + Constants.COMPANION + " answered the heavy door. He looks at me, and sees my desperation.\n");
        ...
        stdout.printf (Constants.HOMETOWN + ". Let me in " + Constants.COMPANION + ", I say frustrated. You know there is no time for a chat. He nods and asks me to follow him. \n");
